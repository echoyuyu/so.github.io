...
class Raven{
    constructor() {
        ...
        //插入图片
        this.img = new Image();
        this.img.src =`./img/zhou${getRandomInt(1,6)}.png`;
...
function drawGameOver(){
    ...
    ctx.fillStyle='black';
    ctx.fillText(`周吃掉了你的脑子,你的分数是：${score}`,canvas.width/2,canvas.height/2);
    ctx.fillStyle='white';
    ctx.fillText(`周吃掉了你的脑子,你的分数是：${score}`,canvas.width/2+5,canvas.height/2+5);
}
